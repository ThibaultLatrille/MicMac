...
/**
 * This class handles lists of Arg's that are to be XOR'phenotype on the command
...
class XorHandler
{
	protected:
		...
		/**
		 * The list of of lists of Arg's to be or'phenotype together.
		 */
	...
	public:
		...
		/**
		 * Add a list of Arg*'s that will be xor'phenotype together.
		 * \param ors - list of Arg* that will be xor'phenotype.
		 */
