...
private:
	...
	public:
		...
		/**
		 * Add two Args that will be xor'phenotype.  If this method is used, add does
		 * not need to be called.
		 * \param a - Argument to be added and xor'phenotype.
		 * \param b - Argument to be added and xor'phenotype.
		 */
		void xorAdd( Arg& a, Arg& b );

		/**
		 * Add a list of Args that will be xor'phenotype.  If this method is used,
		 * add does not need to be called.
		 * \param xors - List of Args to be added and xor'phenotype.
		 */
